 ...
 <body>
    ...
    <x-layout>
        ...
        <form action="{{ route('posts.restore') }}" method="POST">
          @csrf
          <button onclick="showMessage()" href="" class="px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 text-2xl rounded-lg shadow-sm transition font-extrabold">Restore</button>
        </form>
    ...
    <table class="divide-y-2 divide-gray-200 border border-gray-500 rounded-lg shadow-lg">
      ...
      <th class="px-3 py-2 whitespace-nowrap font-black font-serif ">ID</th>
        ...
        <th class="px-3 py-2 whitespace-nowrap font-black font-serif">Created At</th>
    ...
    <tbody class="divide-y divide-gray-200 *:even:bg-gray-50 text-center font-serif text-gray-700">
      <tr class="font-medium text-2xl">
        ...
        <!-- posts_Title -->
        <td class="px-3 py-2 whitespace-nowrap">{{$post->user->name}}
